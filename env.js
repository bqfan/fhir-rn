 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.fhir-rn.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.healthq.fhir-rn'; // ios bundle id
const PACKAGE = 'com.healthq.fhir_rn'; // android package name
const NAME = 'fhir-rn'; // app name
const EXPO_ACCOUNT_OWNER = 'bqfan'; // expo account owner
const EAS_PROJECT_ID = '51369db2-7332-4bf7-8cc7-13f28b59c35c'; // eas project id
const SCHEME = 'fhir-rn'; // app scheme
